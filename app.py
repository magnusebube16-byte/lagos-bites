...
def chat():
    ...
    text = question.lower()
    if "2" in text and "jollof" in text:
        reply = "2 Jollof Rice meals would cost ₦9,000."

    elif "2" in text and "chicken" in text:
        reply = "2 Grilled Chicken meals would cost ₦10,000."

    elif "2" in text and ("pounded" in text or "egusi" in text):
        reply = "2 Pounded Yam & Egusi meals would cost ₦11,000."
